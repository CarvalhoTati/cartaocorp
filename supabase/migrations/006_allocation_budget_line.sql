-- ============================================================
-- CartaoCorp - Add budget_line_id to allocations
-- Run this in the Supabase SQL Editor
-- ============================================================

-- Add budget_line_id column to allocations
ALTER TABLE allocations
  ADD COLUMN budget_line_id UUID REFERENCES budget_lines(id) ON DELETE SET NULL;

CREATE INDEX idx_allocations_budget_line_id ON allocations(budget_line_id);

-- ============================================================
-- Replace create_deposit_with_allocations to support budget_line_id
-- ============================================================
...
-- ============================================================
-- Replace update_deposit_with_allocations to support budget_line_id
-- ============================================================
